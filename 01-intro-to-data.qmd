...
We have installed R, RStudio, git, quarto and tinytex. You have also created a github user. These are the tools that you will need to go further in this course. But what if you run into problems? Do not worry, the internet is at your service!
