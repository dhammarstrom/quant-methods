# Storing data in spreadsheets and tabular data
...
Errors are frequent in spreadsheets, not only because of renaming [@RN2927], but also because of bad formatting of formulas [@RN2928]. These are both reasons for using spreadsheets only for what they do best: data input and data storage.
