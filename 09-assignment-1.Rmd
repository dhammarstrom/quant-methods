...
- Create a [http://www.github.com](github account). All memebers of the group should have their own account.
- Once signed in to github.com, create a new repository with an informative name. Make sure that the repository is public. One member of the group can make this repository in their own account.
...
- You may encounter conflicts if pushing changes that overwrites changes made by other group memebers. These may be tricky but can be resolved... Have patience!
