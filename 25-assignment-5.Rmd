...
The combined load calculated above is a measure of strength without unit (it is not e.g. kg). It can be used to calculate percentage or raw change.
...
You may extend or change these model formulations as long as these changes are explained and motivated by your question/purpose/hypothesis.
